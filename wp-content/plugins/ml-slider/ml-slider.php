 ...
 *
 * Plugin Name: Mytestslider
 * Description: Easy to use slideshow plugin. Create SEO optimised responsive slideshows with Test Slider and Responsive Slides.
 * Version:     3.8.1
 * Author:      Foram Thakkar
 *
...
if (!class_exists('MetaSliderPlugin')) :
    ...
    class MetaSliderPlugin {
        ...
        private function setup_shortcode() {
            ...
            add_shortcode('mytestslider', array($this, 'register_shortcode'));
...
//                $this->admin->add_page('MetaSlider');
                $this->admin->add_page2('MetaSlider', 'My slider');
//                add_menu_page(__('metaslider', 'textdomain'), 'metaslider', 'manage_options', 'admin.php?page=metaslider', '', plugins_url('myplugin/images/icon.png'), 6 );
            }
        ...
        public function do_preview() {
            ...
            if (isset($_GET['slider_id']) && absint($_GET['slider_id']) > 0) {
                ...
                <html>
                    ...
                    <body>
                        <?php echo do_shortcode("[mytestslider id={$id}]"); ?>
                        <?php wp_footer(); ?>
                    </body>
                </html>
                <?php
...
//            }
        ...
        public function update_slider() {
            ...
            if (isset($_POST['title'])) {
                ...
                if (!$result)
                    $errors->add('update_failed', __('There was an error while updating the title.', 'ml-slider'));
            }
...
<!--                                                    <a <?php // echo $count ? '' : "style='display:none;'" ?> class="restore-slide-link" title="<?php // _e('View trashed slides', 'ml-slider'); ?>" href="<?php // echo admin_url("?page=metaslider&id={$this->slider->id}&show_trashed=true"); ?>">
                                                        <i><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><line x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/></svg></i><?php
//                                                        echo __('Trash', 'ml-slider');
//                                                        if ($count)
